                ...
                <ContainerPage>
                    <div className="max-w-5xl text-center">
                        <div className="mb-10">
                            ...
                            <p className="mb-3 text-xl text-gray-300">Ofrezco servicios de Desarrollo Web Front-end especializados en la creación de sitios web y aplicaciones atractivas y funcionales. Utilizando las últimas tecnologías como HTML5, CSS3, JavaScript y React diseño interfaces de usuario intuitivas y responsivas que reflejan la identidad de marca de mis clientes y mejoran su presencia en línea.</p>
                        </div>
