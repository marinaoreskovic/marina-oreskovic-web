...
I am a professional committed to quality and excellence in everything I do.
          ...
          <p className="mx-auto mb-2 text-xl text-center md:text-xl md:mx-0 md:mb-8">
            Me apasiona aprender nuevas tecnologías y aplicar mis conocimientos
            para ayudar a otros a alcanzar sus objetivos. Soy una profesional
            comprometida con la calidad y la excelencia en todo lo que hago.
          </p>
          {/* <p className="mx-auto mb-2 text-xl text-center md:text-xl md:mx-0 md:mb-8">
